...
namespace _04._Mixed_up_Lists
{
    class Program
    {
        ...
        {
            //from Softuni forum ivanpop

            List<int> firstList = new List<int>(Console.ReadLine().Split().Select(int.Parse));
            List<int> secondList = new List<int>(Console.ReadLine().Split().Select(int.Parse));
